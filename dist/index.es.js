...
var ProSidebar = function (_a, ref) {
    ...
    return (React.createElement("div", __assign({}, rest, { ref: sidebarRef, className: classnames('pro-sidebar', className, { collapsed: collapsed, rtl: rtl }), style: { width: width } }),
...
var SubMenu = function (_a, ref) {
    ...
    return (React.createElement("li", { ref: subMenuRef, className: classnames('pro-menu-item pro-sub-menu', className, {
        ...
        React.createElement("div", __assign({}, rest, { className: "pro-inner-item", onClick: handleToggleSubMenu, onKeyPress: handleToggleSubMenu, role: "button", tabIndex: 0 }),
            icon ? (React.createElement("span", { className: "pro-icon-wrapper" },
                React.createElement("span", { className: "pro-icon" }, icon))) : null,
            prefix ? React.createElement("span", { className: "prefix-wrapper" }, prefix) : null,
